 ...
 * @author stasha
 */
public class ResponseAllContentTest extends AbstractTest {
    ...
    public void testFileResponse(Response resp) {
        ...
        Assertions.assertEquals("get classpath response", resp.readEntity(String.class), "Response text should equal");
    }
